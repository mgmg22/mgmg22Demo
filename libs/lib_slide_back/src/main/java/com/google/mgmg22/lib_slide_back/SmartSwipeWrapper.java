...
public class SmartSwipeWrapper extends ViewGroup {
    ...
    private OnInterceptSwipeBack mOnInterceptSwipeBack;
    ...
    public void setOnInterceptSwipeBack(OnInterceptSwipeBack mOnInterceptSwipeBack) {
        this.mOnInterceptSwipeBack = mOnInterceptSwipeBack;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        //为true时不可侧滑
        if (mOnInterceptSwipeBack != null) {
            requestDisallowInterceptTouchEvent(mOnInterceptSwipeBack.isDisallowIntercept());
        }
