...
/**
 * Created by lingjiu on 2018/12/3.
 * 自定义的tabLayout
 * 支持配置选中字体大小、字体颜色、图标指示器等
 */
public class MyTabLayout extends HorizontalScrollView {
    ...
    private MyTabLayout2OnPageChangeListener mPageChangeListener;
    ...
    public MyTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            //选中未选中字体大小
            mNormalTextSize = mSelectedTextSize = mTabTextSize;
        } finally {
            ta.recycle();
        }
        ...
        if (a.hasValue(R.styleable.TabLayout_tabSelectedTextColor)) {
            ...
            mNormalTextColor = mSelectedTextColor = mTabTextColors.getDefaultColor();
        }
     ...
     * @attr ref R.styleable#MyTabLayout2_tabIndicatorColor
     */
     ...
     * @attr ref R.styleable#MyTabLayout2_tabIndicatorHeight
     */
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to a different MyTabLayout2.");
        }
    ...
    public void removeTab(Tab tab) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab does not belong to this MyTabLayout2.");
        }
     ...
     * @attr ref R.styleable#MyTabLayout2_tabMode
     */
     ...
     * @attr ref R.styleable#MyTabLayout2_tabGravity
     */
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref R.styleable#MyTabLayout2_tabTextColor
     * @attr ref R.styleable#MyTabLayout2_tabSelectedTextColor
     */
    public MyTabLayout setTabTextColors(int normalColor, int selectedColor) {
     ...
     */
    public MyTabLayout setupWithViewPager(@Nullable ViewPager viewPager) {
     ...
     * The one-stop shop for setting up this {@link MyTabLayout} with a {@link ViewPager}.
     * <p>
     * <p>This method will link the given ViewPager and this MyTabLayout2 together so that
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new MyTabLayout2OnPageChangeListener(this);
            }
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(ViewPager)} to link a MyTabLayout2 with a ViewPager
     * together. When that method is used, the MyTabLayout2 will be automatically updated
    ...
    private void addViewInternal(final View child) {
        if (child instanceof TabItem) {
            ...
            throw new IllegalArgumentException("Only TabItem instances can be added to MyTabLayout2");
        }
    }
    ...
    public static final class Tab {
        ...
        public Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a MyTabLayout2");
            }
    ...
    class TabView extends LinearLayout {
        ...
        public boolean performClick() {
            ...
            if (mTab != null) {
                ...
                //是否拦截点击事件
                boolean isInterceptor = onInterceptorClickListener != null &&
                        onInterceptorClickListener.onInterceptorClick(mTab.mPosition);
                if (!isInterceptor)
                    mTab.select();
                return true;
            } else {
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (mTextView != null) {
                ...
                textSize = mTextView.isSelected() ? mSelectedTextSize : mNormalTextSize;//增加代码
                int textColor = mTextView.isSelected() ? mSelectedTextColor : mNormalTextColor;//增加代码
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (updateTextView) {
                        ...
                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);//增加注释
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            if (mIndicatorAnimator != null && mIndicatorAnimator.isRunning()) {
                // If we're currently running an animation, lets cancel it and goHome a
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                //增加代码 使用自定义指示器
                //指示器居中显示
                int mid = (mIndicatorRight - mIndicatorLeft - getSlideIcon().getWidth()) / 2;
                if (getSlideIcon() != null) {
                    canvas.drawBitmap(getSlideIcon(), mIndicatorLeft + mid, getHeight() - mSelectedIndicatorHeight - getTabBottomMargin(), null);
                    return;
                }
                canvas.drawRect(mIndicatorLeft + mid, getHeight() - mSelectedIndicatorHeight - getTabBottomMargin(),
                        mIndicatorRight - mid, getHeight() - getTabBottomMargin(), mSelectedIndicatorPaint);
            }
        }
    }
     ...
     * kept in sync.
     * <p>
     * <p>This class stores the provided MyTabLayout2 weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    public static class MyTabLayout2OnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<MyTabLayout> mMyTabLayout2Ref;
        private int mPreviousScrollState;
        private int mScrollState;

        public MyTabLayout2OnPageChangeListener(MyTabLayout MyTabLayout2) {
            mMyTabLayout2Ref = new WeakReference<>(MyTabLayout2);
        }
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final MyTabLayout MyTabLayout2 = mMyTabLayout2Ref.get();
            if (MyTabLayout2 != null) {
                ...
                MyTabLayout2.setScrollPosition(position, positionOffset, updateText, updateIndicator);
            }
        }
        ...
        public void onPageSelected(final int position) {
            final MyTabLayout MyTabLayout2 = mMyTabLayout2Ref.get();
            if (MyTabLayout2 != null && MyTabLayout2.getSelectedTabPosition() != position
                    && position < MyTabLayout2.getTabCount()) {
                // Select the tab, only updating the indicator if we're not being dragged/settled
                // (since onPageScrolled will handle that).
                final boolean updateIndicator = mScrollState == SCROLL_STATE_IDLE
                        || (mScrollState == SCROLL_STATE_SETTLING
                        && mPreviousScrollState == SCROLL_STATE_IDLE);
                MyTabLayout2.selectTab(MyTabLayout2.getTabAt(position), updateIndicator);
            }
        }
    ...
    private float mNormalTextSize, mSelectedTextSize;
    //tabView的点击监听,可做拦截
    ...
    public MyTabLayout setSlideIcon(Bitmap mSlideIcon) {
        this.mSlideIcon = mSlideIcon;
        return this;
    }

    public MyTabLayout setTitleBold(boolean titleBold) {
        isTitleBold = titleBold;
        return this;
    }

    public MyTabLayout setTabTextColor(int normalTextColor, int selectedTextColor) {
     ...
     * @return
     */
    public MyTabLayout setTabTextSize(int normalTextSize, int selectedTextSize) {
        mNormalTextSize = normalTextSize == 0 ? mTabTextSize : spToPx(normalTextSize);
        mSelectedTextSize = selectedTextSize == 0 ? mTabTextSize : spToPx(selectedTextSize);
        return this;
    }

    private float spToPx(float sp) {
        return Math.round(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, sp, getContext().getResources().getDisplayMetrics()));
    }
    ...
    private int getTabLayoutOffsetWidth(int index) {
        ...
        for (int i = 0; i < index; i++) {
            width += getTabAt(i).mView.getWidth();
        }
        return width;
    }

    public MyTabLayout addTabs(String... tabs) {
    ...
    public MyTabLayout setTabBottomMargin(int margin) {
        mTabBottomMargin = dpToPx(margin);
        return this;
    }
    ...
    public MyTabLayout setBottomLineColor(int lineColor) {
    ...
    public interface OnInterceptorClickListener {
        boolean onInterceptorClick(int position);
    }

    public MyTabLayout setOnInterceptorClickListener(OnInterceptorClickListener listener) {
        onInterceptorClickListener = listener;
        return this;
    }

    public MyTabLayout setTabSelectedListener(TabSelectedListener listener) {
        addOnTabSelectedListener(new WrapperTabSelectedAdapter(listener));
        return this;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        initPaintIfNeeded();
        canvas.drawLine(0,
                getHeight(), getWidth(), getHeight(), mPaint);
    }
    ...
    class WrapperTabSelectedAdapter implements OnTabSelectedListener {
        TabSelectedListener listener;
        //是否选择过
        boolean isFromUserSelected;

        public WrapperTabSelectedAdapter(TabSelectedListener listener) {
        ...
        public void onTabReselected(Tab tab) {
            if (listener != null) {
                listener.onTabSelected(tab, isFromUserSelected);
            }
        }
    }
