...
public class YCRedDotView extends AppCompatTextView {
    ...
    private void setTextView() {
        setTextColor(Color.parseColor("#EF2635"));
        setTypeface(Typeface.DEFAULT_BOLD);
        setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        setPadding(dip2Px(5), dip2Px(1), dip2Px(5), dip2Px(1));
        setBackground(8.5f, Color.WHITE);
    ...
    private void setBackground(float dipRadius, int badgeColor) {
        ...
        gd.setCornerRadius(dip2Px(dipRadius));
        gd.setStroke(dip2Px(1), Color.parseColor("#EF2635"));//描边的颜色和宽度
        gd.setGradientType(RECTANGLE);
...
//        setBadgeCount(count > 99 ? "99+" : String.valueOf(count));
        setBadgeCount(String.valueOf(count));
    }
